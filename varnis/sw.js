 ...
 * keeps working when deployed under a subpath (e.g. /varnis/).
 * Only GET requests are ever cached (Cache API throws on POST).
 */

const VERSION = "v4";
const STATIC_CACHE = "varnis-static-" + VERSION;
const RUNTIME_CACHE = "varnis-runtime-" + VERSION;
...
const PRECACHE_URLS = [
  ...
  "public/recovery-new.html",
  "public/recovery-detail.html",
  "public/support-tickets.html",
  "public/support.html",
  "admin/index.html",
  "admin/reports.html",
  "admin/settings.html",
...
async function networkFirstNavigation(request) {
  try {
    ...
    return new Response(
      "<!DOCTYPE html><html><head><meta charset='utf-8'><title>Offline — Varnis</title></head>" +
