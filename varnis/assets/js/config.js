...
window.VarnisConfig = {
  ...
  // network. Since no backend ships with this bundle, mocks are the default —
  // set to false once API_BASE_URL points at your live backend. Override at
  // runtime anytime with ?live=1 (force network) or ?mock=1 (force mocks).
  USE_MOCKS: true,
