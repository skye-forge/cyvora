...
(function () {
  ...
  function mount(container, opts) {
    ...
    function finish(ranOut) {
      ...
      if (opts.quizId && window.VarnisAPI && window.VarnisAPI.learning && window.VarnisAPI.learning.submitQuiz) {
        window.VarnisAPI.learning.submitQuiz(opts.quizId, result).catch(function () {});
      }
