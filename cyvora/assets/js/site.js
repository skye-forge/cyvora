...
(function () {
  ...
  window.addEventListener("DOMContentLoaded", function () {
    ...
    (function () {
      ...
      if (so) so.addEventListener("click", function (e) {
        ...
        if (window.CyvoraAPI && window.CyvoraAPI.auth) window.CyvoraAPI.auth.logout().then(done, done);
        else done();
      });
    })();
    ...
    (function restoreAvatar() {
      try {
        var photo = window.CyvoraStore && window.CyvoraStore.get("profile_photo", null);
        if (!photo) return;
  ...
  /* ============================================================
     ...
     ============================================================ */
  window.CyvoraUI = window.CyvoraUI || {};

  window.CyvoraUI.showLoading = function (container, type = 'spinner') {
    if (!container) return;
    container.innerHTML = '';
  ...
  window.CyvoraUI.hideLoading = function (container, originalContent = null) {
    if (!container) return;
    if (originalContent) {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if ('serviceWorker' in navigator) {
      navigator.serviceWorker.register('../sw.js')
        .then((registration) => {
          console.log('[Cyvora] Service Worker registered successfully');
          ...
          registration.onupdatefound = () => {
            ...
            installingWorker.onstatechange = () => {
              if (installingWorker.state === 'installed' && navigator.serviceWorker.controller) {
                console.log('[Cyvora] New content is available. Please refresh the page.');
              }
            };
          };
        })
        .catch((err) => {
          console.log('[Cyvora] Service Worker registration failed:', err);
        });
    }
        ...
        installBtn.onclick = () => {
          ...
          deferredPrompt.userChoice.then((choiceResult) => {
            if (choiceResult.outcome === 'accepted') {
              console.log('[Cyvora] User accepted the install prompt');
            }
            deferredPrompt = null;
  ...
  function initInlineValidation(form) {
    if (!form || !window.CyvoraValidation) return;

    var V = window.CyvoraValidation;
    ...
    inputs.forEach(function (input) {
      ...
      function validateField() {
        ...
        // Use existing validators from CyvoraValidation
