...
(function () {
  ...
  var translations = {
    en: {
      ...
      "recovery.start": "Start a recovery request",
      "recovery.fee": "Tracking fee",
    ...
    fr: {
      ...
      "kyc.status.draft": "Non commencée",
      "kyc.status.submitted": "Soumise",
      "kyc.status.under_review": "En cours d'examen",
      "kyc.status.approved": "Approuvée",
      "kyc.status.rejected": "Rejetée",
      "kyc.status.expired": "Expirée",
      "recovery.title": "Centre de récupération",
      "recovery.start": "Lancer une demande de récupération",
      "recovery.fee": "Frais de traçage",
