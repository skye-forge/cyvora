/**
 * Cyvora — Input Validation & Security Layer
 * ------------------------------------------------------------
...
(function () {
  ...
  var ALLOWED_CATEGORIES = [
    "Phishing", "Malware", "Social Engineering", "Infrastructure",
    "Cyberbullying", "Data Breach", "Scam", "Other"
  ];
  var ALLOWED_SEVERITIES = ["low", "medium", "high", "critical"];
  var ALLOWED_REGIONS = ["North", "South", "East", "West", "Centre", "Adamawa", "Far North", "Littoral", "North West", "South West", "Yaoundé", "Douala"];
  ...
  // Also attach to CyvoraAPI for convenience in future
  if (window.CyvoraAPI) {
    window.CyvoraAPI._validation = window.CyvoraValidation;
  }

  console.log("[Cyvora] Input validation & security layer loaded.");
})();
